...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 1489942108140495879),
      name: 'NoteEntity',
      lastPropertyId: const IdUid(3, 8387122226308643398),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 7872763520520208126),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 4109670190396348735),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 8387122226308643398),
            name: 'body',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 1489942108140495879),
  ...
  final bindings = <Type, EntityDefinition>{
    NoteEntity: EntityDefinition<NoteEntity>(
        ...
        objectFromFB: (Store store, ByteData fbData) {
          ...
          final object = NoteEntity(title: titleParam, body: bodyParam)
